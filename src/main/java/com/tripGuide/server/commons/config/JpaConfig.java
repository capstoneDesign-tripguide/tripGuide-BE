...
@Configuration
@EnableJpaRepositories(basePackages = {"com.tripGuide.server.commons.security.token.repository",
        "com.tripGuide.server.user.repository",})
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        entityManagerFactory.setPackagesToScan("com.tripGuide.server");
        // JPA 벤더 어뎁터를 설정한다.
